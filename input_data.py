...
class AudioProcessor(object):
  ...
  def prepare_data_index(self, silence_percentage, unknown_percentage,
    ...
    for wav_path in gfile.Glob(search_path):
      _,word,_ = wav_path.split('\\')
      # print(s)
      # print(m)
      # print(l)
      # try:
      #   word = re.search(r'.*/([^/]+)/.*.wav', wav_path).group(1).lower()
      #   print(word)
      # except:
      #   word = None
    ...
    # print(self.data_index['training'])
  ...
  def get_data(self, how_many, offset, model_settings, background_frequency,
    ...
    data = np.zeros((sample_count, int(model_settings['fingerprint_size'])))
